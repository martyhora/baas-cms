...
export default class ContentFormContainer extends React.Component<IContentFormContainerProps, IContentFormContainerState> {
    constructor() {
        super();
    ...
    handleSubmit(): void {
        const dataToSave = {
            parameters: this.state.parameters.map((parameter: IParameter) => { return { id: parameter.id, value: parameter.value } }),
