        ...
        <div className="wrapper">
            <header className="main-header">
              ...
              <a href="" className="logo">
                <span className="logo-mini"><b>BaaS</b> CMS</span>

                <span className="logo-lg"><b>BaaS</b> CMS</span>
              </a>
                ...
                <section className="sidebar">
                    ...
                    <ul className="sidebar-menu">
                        <li className="treeview">
                            <a href="#"><i className="fa fa-link"></i> <span>Parametry</span> <i className="fa fa-angle-left pull-right"></i></a>
                            <ul className="treeview-menu">
                                <li><Link to="/parameter">Parametry</Link></li>
                                <li><Link to="/parameter/add">Nový parametr</Link></li>
                            </ul>
                        </li>

                        <li className="treeview">
                            <a href="#"><i className="fa fa-link"></i> <span>Sekce</span> <i className="fa fa-angle-left pull-right"></i></a>
                            <ul className="treeview-menu">
                                <li><Link to="/section">Sekce</Link></li>
                                <li><Link to="/section/add">Nová sekce</Link></li>
                            </ul>
                        </li>
                        <li className="treeview">
                            <a href="#"><i className="fa fa-link"></i> <span>Obsah</span> <i className="fa fa-angle-left pull-right"></i></a>
                            <ul className="treeview-menu">
                                <li><Link to="/content">Přehled obsahu</Link></li>
                                <li><Link to="/content/add">Nový obsah</Link></li>
                            </ul>
                        </li>
                    </ul>
                </section>
            ...
            <div className="content-wrapper">
                <section className="content-header">
                    ...
                    <Route name="parameter-edit" path="/parameter/edit/:id" component={ParameterFormContainer}/>
